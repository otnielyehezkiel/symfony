...
abstract class BaseMaterialPeer {
	...
	/** the column name for the MATNR field */
	const MATNR = 'material.MATNR';

	/** the column name for the MTART field */
	const MTART = 'material.MTART';

	/** the column name for the MBRSH field */
	const MBRSH = 'material.MBRSH';

	/** the column name for the MAKTX field */
	const MAKTX = 'material.MAKTX';

	/** the column name for the MEINS field */
	const MEINS = 'material.MEINS';

	/** the column name for the MATKL field */
	const MATKL = 'material.MATKL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Matnr', 'Mtart', 'Mbrsh', 'Maktx', 'Meins', 'Matkl', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'matnr', 'mtart', 'mbrsh', 'maktx', 'meins', 'matkl', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::MATNR, self::MTART, self::MBRSH, self::MAKTX, self::MEINS, self::MATKL, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'MATNR', 'MTART', 'MBRSH', 'MAKTX', 'MEINS', 'MATKL', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Matnr' => 1, 'Mtart' => 2, 'Mbrsh' => 3, 'Maktx' => 4, 'Meins' => 5, 'Matkl' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'matnr' => 1, 'mtart' => 2, 'mbrsh' => 3, 'maktx' => 4, 'meins' => 5, 'matkl' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MATNR => 1, self::MTART => 2, self::MBRSH => 3, self::MAKTX => 4, self::MEINS => 5, self::MATKL => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'MATNR' => 1, 'MTART' => 2, 'MBRSH' => 3, 'MAKTX' => 4, 'MEINS' => 5, 'MATKL' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MaterialPeer::MATNR);
		$criteria->addSelectColumn(MaterialPeer::MTART);
		$criteria->addSelectColumn(MaterialPeer::MBRSH);
		$criteria->addSelectColumn(MaterialPeer::MAKTX);
		$criteria->addSelectColumn(MaterialPeer::MEINS);
		$criteria->addSelectColumn(MaterialPeer::MATKL);
	}
